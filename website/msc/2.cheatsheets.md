...
### Case study 2: Matlab, TensorFlow and PyTorch

### Read the trend: Open source wins?
...
Use `CTRL-C` to exit any program. Use `CTRL-D` to exit a shell, an REPL and other input streams.

The bash grammar is well summarized in [this cheatsheet](https://devhints.io/bash).
The following is a cheatsheet for commands that will be used in this course.
