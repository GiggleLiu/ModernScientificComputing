...
# ╔═╡ ed1d5cb6-516c-4ce9-9ba1-3119cda457a4
generate_gaussian_packet(500, 200; k0=0.3, Δx=20)

# ╔═╡ 10561a2d-32c5-4360-942e-a60b9791beb8
let
	y = generate_gaussian_packet(500, 200; k0=0.1, Δx=20)
	plot(abs.(y); linez=angle.(y), colorbar=false,
		colormap=:cyclic_wrwbw_40_90_c42_n256_s25,
		xlabel="x", ylabel="amplitude", label="")
end
...
let
	k = 0:127
	y = fourier_transform.(x->cos(π * x), Ref(0:1/128:0.99), k)
...
manifest_format = "2.0"
project_hash = "fff5527dad30284dd9ec27316c82c4f5ef0f7683"
